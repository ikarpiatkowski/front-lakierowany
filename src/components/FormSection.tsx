			...
			<div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 lg:items-center">
				<div className="p-6 pb-0 lg:pb-6">
					...
					<p className="text-brand-light/60 mb-8 max-w-md">
						Wypełnij poniższy formularz, aby przygotować wycenę lub złożyć
						zamówienie. Odpowiadamy zwykle w ciągu 2 godzin roboczych.
					</p>

					<div className="space-y-6">
						<div>
							<p className="text-sm font-bold uppercase tracking-widest text-brand-primary mb-2">
								Bezpośredni kontakt
							</p>
							<p className="text-2xl font-display">{COMPANY_INFO.phone}</p>
							<p className="text-brand-light/40">
						...
						<div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
							<h4 className="font-bold mb-2">
								Chcesz załączyć zdjęcia lub pliki?
							</h4>
							<p className="text-sm text-brand-light/60 mb-4">
								Prześlij je bezpośrednio na nasz adres mail.
							</p>
							<a
							...
							children={(field) => (
								<div>
									...
									<input
										...
										className={cn(
											"mt-1.5 w-full bg-brand-light border-none rounded-lg px-4 py-3 focus:ring-2 focus:ring-brand-primary outline-none transition-all",
							...
							children={(field) => (
								<div>
									...
									<textarea
										...
										onChange={(e) => field.handleChange(e.target.value)}
										className={cn(
											"mt-1.5 w-full bg-brand-light border-none rounded-lg px-4 py-3 focus:ring-2 focus:ring-brand-primary outline-none transition-all resize-y min-h-[150px]",
											field.state.meta.errors.length > 0 &&
												"ring-2 ring-red-500",
										)}
