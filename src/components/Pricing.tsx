...
export function Pricing() {
  return (
    <section id="cennik" className="section-container bg-white">
      <div className="mb-16">
        <h2 className="text-4xl md:text-5xl font-display mb-4">Cennik</h2>
        <p className="text-brand-muted max-w-2xl text-lg">
          Przejrzyste ceny hurtowe dla stolarzy i firm meblowych. Podane ceny są cenami netto za m².
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-6">
            ...
            <table className="w-full text-left">
              <thead className="bg-brand-dark text-white font-display uppercase text-xs tracking-wider">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right">Cena (stolarz)</th>
                </tr>
              </thead>
          ...
          <div className="bg-brand-primary/5 border border-brand-primary/10 rounded-2xl p-6 flex gap-4">
            <div className="bg-brand-primary text-white p-2 rounded-full h-fit">
              <Info className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-bold text-brand-primary mb-1">Promocja wiosenna!</h4>
              <p className="text-sm text-brand-primary/80">Pierwsze 3 zamówienia otrzymają dodatkowe 10% zniżki na całość usługi.</p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={text} className="flex items-center gap-3 text-brand-muted text-sm px-1">
